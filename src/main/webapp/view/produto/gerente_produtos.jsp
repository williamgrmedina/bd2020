								...
								<td>
									...
									<a	class="h3"
									   ...
									   data-target="#modal_edit_prod_nome" >
										<i 
											class="fa fa-pencil link_editar_produto_nome"
											data-toggle="tooltip"
								...
								<td>
									...
									<a	class="h3"
									   ...
									   data-target="#modal_edit_prod_val_compra" >
										<i 
											class="fa fa-pencil link_editar_produto_val_compra"
											data-toggle="tooltip"
											data-original-title="Editar" > 
										</i>
									</a>
								...
								<td>
									...
									<a	class="h3"
									   ...
									   data-target="#modal_edit_prod_val_venda" >
										<i 
											class="fa fa-pencil link_editar_produto_val_venda"
											data-toggle="tooltip"
											data-original-title="Editar" > 
										</i>
									</a>
								...
								<td>
									...
									<a	class="h3"
									   ...
									   data-target="#modal_edit_prod_qtd" >
										<i 
											class="fa fa-pencil link_editar_produto_qtd"
											data-toggle="tooltip"
											data-original-title="Editar" > 
										</i>
									</a>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form
							...
							<input id="prod_id" type="hidden" name="prod_id" value="!substituted in javascript file!"/>
